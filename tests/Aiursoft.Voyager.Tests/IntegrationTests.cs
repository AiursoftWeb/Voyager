...
public class IntegrationTests
{
    ...
    private string _tempAssetsFolder = Path.Combine(Path.GetTempPath(), $"Voyager-UT-{Guid.NewGuid()}");
    ...
    {
        _tempAssetsFolder = Path.Combine(Path.GetTempPath(), $"Voyager-UT-{Guid.NewGuid()}");
